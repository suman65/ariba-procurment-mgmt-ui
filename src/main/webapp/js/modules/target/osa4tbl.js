...
var TARGET_OSA_TBL =	
{
	init: function()
	{
		this.defineTargetOSA4TBL();
	}
	,defineTargetOSA4TBL : function()
	{
		Ext.define('ATP.data.TARGET_OSA_TBL',
		{
	...
	,getSeasonCalendars: function()
	{
		return Ext.create('Ext.data.ComboStore',
		{
			...
			,proxy 		: 
			{
				...
				,extraParams: {activityId: CONSTANTS.ACTIVITY_IDS.OSA}
				,reader 	: 'combojsonreader'
			}
		});
	}
	,getTargetOSA4TBLs: function(extraParams)
	{
		var proxy = {
				type		: 'ajax'
				...
				,batchActions: false
				,extraParams: {actionType : 'targetDemandOSA4TBLService'}
				,reader		: 'jsonreader'
				,writer		:
				{
					type	: 'json'
	...
	,getTargetOSA4TBLGrid : function()
	{
		var me			=	this;
		var targetOSA4TBLGrid	=	{
			xtype		: 'customgrid'
			,autoLoad	: false
			,itemId		: 'targetOSA4TBL'
			,store		: me.getTargetOSA4TBLs()
